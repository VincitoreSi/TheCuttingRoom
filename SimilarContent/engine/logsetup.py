...
Every SimilarContent command calls setup_logging(command, platform) ONCE at startup. It
...
Modules do `log = logging.getLogger("sc.render")` and pass structured fields via
